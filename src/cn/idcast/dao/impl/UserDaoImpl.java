...
public class UserDaoImpl implements UserDao {
   ...
   public void update(User user) {
      String sql = "update users set name = ?,gender = ? ,age = ? , address = ? , qq = ?," +
              " email = ? where id = ?";
   ...
   public List<User> findByPage(int start, int rows, Map<String, String[]> condition) {
      ...
      return template.query(sql.toString(),new BeanPropertyRowMapper<User>(User.class),params.toArray());
